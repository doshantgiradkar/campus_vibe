...
export default function Footer() {
  ...
  return (
    <footer className="bg-gradient-to-b from-white to-gray-50 pt-16 border-t border-gray-100">
      <div className="max-w-screen-xl mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          <div className="col-span-1 md:col-span-1">
            <Link to="/" className="flex items-center mb-6">
              <span className="self-center text-2xl font-bold text-primary-600">
                Campus Vibe
              </span>
            </Link>
            <p className="text-gray-600 mb-6 max-w-sm">
              Connecting students, faculty, and organizations to create a vibrant and engaging campus community.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link to="/departments" className="text-gray-600 hover:text-primary-600 transition-colors">
                  Departments
                </Link>
              </li>
              <li>
                <Link to="/map" className="text-gray-600 hover:text-primary-600 transition-colors">
                  Campus Map
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link to="/guidelines" className="text-gray-600 hover:text-primary-600 transition-colors">
              ...
              <li>
                <Link to="/feedback" className="text-gray-600 hover:text-primary-600 transition-colors">
                  Feedback
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <p className="text-gray-600 mb-4">
              Stay updated with the latest events, news, and announcements
            </p>
            <form className="space-y-2">
              <div className="flex">
                <input 
                  ...
                  className="w-full px-4 py-2 rounded-l-lg border border-gray-300 focus:ring-primary-500 focus:border-primary-500"
                  required
                />
                <button 
                  type="submit" 
        ...
        <div className="border-t border-gray-200 pt-8 pb-12">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-500 text-sm mb-4 md:mb-0">
              © {currentYear} Campus Vibe. All Rights Reserved.
            </p>
